      ...
      <Styles.Center>
        ...
        <Styles.Info>
          <Styles.OptionsForClient>
            ...
            <br />
            <Text color='white' fontWeight='normal' fontSize='small'>Sobre a <strong>Marks Joias</strong></Text>
            <Text color='white' fontWeight='normal' fontSize='small'>Politica para Revendedores</Text>
          </Styles.OptionsForClient>
          ...
          <Styles.OptionsForClient>
            ...
            <br />
            <Text color='white' fontWeight='normal' fontSize='small'>Contate-nos</Text>
            <Text color='white' fontWeight='normal' fontSize='small'>Trocas e Devoluções</Text>
            <Text color='white' fontWeight='normal' fontSize='small'>Pontos Bônus</Text>
          </Styles.OptionsForClient>
        </Styles.Info>
